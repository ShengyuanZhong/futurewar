...
升级策略为0.3.6；维修说明更新至0.3.7，2026-09-22。独立任务、墙掩护、让行和动态备货见[工人协作](WORKER_COORDINATION.md)。按用户新蓝图调整升级投资，涉及R03建造/死亡、R06升级券/修复包；官方规则不变。保留0.3.5任务模块和既有U形阵型。修改前源码及文档保存于[0.3.5快照](../../reports/baselines/v0.3.5-source.zip)和[哈希清单](../../reports/baselines/v0.3.5-manifest.json)，历史0.3.2基准继续保留。
