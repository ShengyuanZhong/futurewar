...
更新日期：2026-09-22，版本0.3.7。本轮增加逐工人任务/目的格、协作让行、城墙掩护、上下分区值守与动态修复包库存，见[工人协作开发文档](WORKER_COORDINATION.md)。涉及R02/R03/R05/R06。升级顺序与基地不升级保持，任务模块和官方原件不变。
...
6. 先安排开拓者，再按停滞情况、维修身份和ID分别控制工人；白天开局建设/经济，夜间普通工人避险挖矿、维修工墙内值守；全部目标完成后两人全天墙内维修，白天轮流买包；持有Medicine的低血量角色优先用药。开局未完成时暂停普通券采购和宝藏采购。
